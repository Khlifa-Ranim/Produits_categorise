package com.ranim.produits.controllers;

import com.ranim.produits.entities.Categorie;
import com.ranim.produits.service.CategorieService;
...
public class ProduitController {
	...
	// @RequestMapping("/showCreate")
		...
		public String ListeCategorie(ModelMap modelMap, @RequestParam(name = "page", defaultValue = "0") int page,
